          ...
          <div className="flex gap-4 md:gap-5">
            {images.map((image, index) => (
              <button
                ...
                className="min-w-0 flex-[0_0_48%] md:flex-[0_0_38%] lg:flex-[0_0_31%] xl:flex-[0_0_24%] group overflow-hidden rounded-2xl bg-white shadow-lg text-left"
              >
                <div className="relative aspect-[3/4] w-full">
                  <Image
                    ...
                    fill
                    loading="lazy"
                    sizes="(max-width: 768px) 48vw, (max-width: 1024px) 38vw, (max-width: 1280px) 31vw, 24vw"
