...
export default function RootLayout({
  ...
  return (
    <html lang="tr" className={`${playfair.variable} ${inter.variable} scroll-smooth`} data-scroll-behavior="smooth">
      <body className="font-sans antialiased bg-[var(--background)] text-gray-800">
        {children}
      </body>
    </html>
  )
